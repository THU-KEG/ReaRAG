...
async def _generate(request_dict: dict, raw_request: Request) -> Response:
    ...
    # text_outputs = ('\n').join([output.text for output in final_output.outputs])
    # ret = {"generated_text": text_outputs}

    # generated_text = ('\n').join([output.text for output in final_output.outputs]).strip()
    # stop_reason = final_output.outputs.stop_reason
    # return_outputs = [
    #     {
    #         "prompt": prompt,
